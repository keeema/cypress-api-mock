...
"use strict";
eval("\r\nvar _a, _b;\r\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\r\nvar server_1 = __webpack_require__(/*! ../server */ \"./server.ts\");\r\nvar port = !isNaN(+((_a = process.argv) === null || _a === void 0 ? void 0 : _a[2])) ? +((_b = process.argv) === null || _b === void 0 ? void 0 : _b[2]) : 3000;\r\nserver_1.startServer({ apiMockServer: { hostname: \"0.0.0.0\", hostPort: port } });\r\n\n\n//# sourceURL=webpack://cypress-api-mock/./server/startServer.ts?");
...
"use strict";
eval("module.exports = require(\"timers\");;\n\n//# sourceURL=webpack://cypress-api-mock/external_%22timers%22?");
...
/******/ 	return __webpack_require__("./server/startServer.ts");
/******/ })()
;